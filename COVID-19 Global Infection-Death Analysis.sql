...
--Countries with Highest Infection Count compared to Population by date
SET ARITHABORT OFF
SET ANSI_WARNINGS OFF
...
Create View HighestInfectionCountbyContinent as
Select location, MAX(total_cases) as TotalInfectionCount
From PortfolioProject..CovidDeaths
Where continent = ' ' 
and location not in ('world','european union','international')
...
SELECT *
FROM HighestInfectionCountbyContinent
